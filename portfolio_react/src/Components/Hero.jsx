import Foto from '../assets/Images/Perfil_Profissional.jpg'

const Hero = () => {
    return ( 
        <>
            <section className="text-w1 max-w-[1080px] m-auto px-3 flex justify-between max-md:flex-col">
                ...
                <div className="flex justify-center align-items-center max-md:w-auto md:w-6 max-md:my-2" >
                    <img src={Foto} alt="foto-perfil" className='w-[400px]'/>
                </div>
            </section>
        </>
     );
